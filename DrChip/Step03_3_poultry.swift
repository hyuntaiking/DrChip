...
class Step03_3_poultry: UIViewController {
    ...
    @IBAction func swipeBack(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "step03_2_poultry")
        show(vc!, sender: self)
    }
    ...
    override func viewDidLoad() {
        ...
        app.lastStoryboardID = "step03_3_poultry"
    }
